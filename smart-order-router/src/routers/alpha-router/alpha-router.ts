    ...
    ISwapToRatio<AlphaRouterConfig, SwapAndAddConfig>
{
  ...
  constructor({
    ...
    console.log('Constructor AlphaRouter - 0 - ', provider, chainId);
    this.chainId = chainId;
    this.provider = provider;
    this.multicall2Provider =
      multicall2Provider ??
      new UniswapMulticallProvider(chainId, provider, 375_000);
    console.log('Constructor AlphaRouter - 1 - ', this.multicall2Provider);
    this.v3PoolProvider =
      v3PoolProvider ??
    ...
    console.log('Constructor AlphaRouter - 2 - ', this.v3PoolProvider);
    this.simulator = simulator;
    this.routeCachingProvider = routeCachingProvider;
    console.log('Constructor AlphaRouter - 3 - ', onChainQuoteProvider);
    ...
    console.log('Constructor AlphaRouter - 4 - ', this.tokenProvider);
    const chainName = ID_TO_NETWORK_NAME(chainId);
    console.log('Constructor AlphaRouter - 5 - ', chainName);
    ...
    console.log('Constructor AlphaRouter - 6');
    ...
    console.log('Constructor AlphaRouter - 7 - ', this.v3Quoter);
