...
export const HARDHAT_LIST =
  'https://raw.githubusercontent.com/vimageDE/uniswap/new-chain/interface/apps/web/src/constants/tokenLists/hardhat_token_list.json'
